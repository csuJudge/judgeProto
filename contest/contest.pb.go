...
type ContestProblem struct {
	...
	PassRate      float32                `protobuf:"fixed32,8,opt,name=passRate,proto3" json:"passRate,omitempty"`     // 通过率
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ContestProblem) GetPassRate() float32 {
	if x != nil {
		return x.PassRate
	}
	return 0
...
const file_contest_proto_rawDesc = "" +
	...
	"\tCommonRsp\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x12\n" +
	"\x04code\x18\x02 \x01(\x05R\x04code\"\xf2\x01\n" +
	...
	"\bpassRate\x18\b \x01(\x02R\bpassRate2\xff\x06\n" +
	"\rContestServer\x12J\n" +
