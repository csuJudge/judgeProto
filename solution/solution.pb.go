...
var file_solution_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x49, 0x44, 0x22, 0x4d, 0x0a, 0x1d, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x73, 0x65,
	...
	0x6f, 0x64, 0x65, 0x22, 0x4c, 0x0a, 0x14, 0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x62, 0x6c,
	0x65, 0x6d, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x70,
	0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09,
	0x70, 0x72, 0x6f, 0x62, 0x6c, 0x65, 0x6d, 0x49, 0x44, 0x12, 0x16, 0x0a, 0x06, 0x69, 0x73, 0x44,
	0x6f, 0x6e, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x69, 0x73, 0x44, 0x6f, 0x6e,
	0x65, 0x22, 0xa4, 0x01, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x6f, 0x64, 0x61, 0x79,
	...
	0x01, 0x28, 0x05, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x3f, 0x0a, 0x0a, 0x73, 0x74, 0x61,
	0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e,
	...
	0x73, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69,
	0x6d, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x04, 0x20, 0x03, 0x28, 0x05, 0x52, 0x09, 0x74,
	0x69, 0x6d, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x23, 0x0a, 0x09, 0x55, 0x73, 0x65, 0x72,
	...
	0x6c, 0x65, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x4f, 0x0a, 0x17,
	...
	0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0xa2, 0x01,
...
var file_solution_proto_depIdxs = []int32{
	13, // 0: oj.solution.QueryTodaySolutionRsp.statistics:type_name -> oj.solution.ClassifiedSolution
	16, // 1: oj.solution.QueryMySolutionRecordRsp.acceptProblems:type_name -> oj.solution.Problem
	16, // 2: oj.solution.QueryMySolutionRecordRsp.unAcceptProblems:type_name -> oj.solution.Problem
	11, // 3: oj.solution.CountContestProblemSubmissionRsp.statistics:type_name -> oj.solution.ProblemClassifiedSolution
	13, // 4: oj.solution.ProblemClassifiedSolution.statistics:type_name -> oj.solution.ClassifiedSolution
	13, // 5: oj.solution.CountContestSubmissionRsp.statistics:type_name -> oj.solution.ClassifiedSolution
	16, // 6: oj.solution.QueryContestRankDataRsp.problems:type_name -> oj.solution.Problem
	17, // 7: oj.solution.QueryContestRankDataRsp.ranks:type_name -> oj.solution.Rank
	18, // 8: oj.solution.Rank.solutionData:type_name -> oj.solution.ContestSolutionData
	44, // 9: oj.solution.QuerySolutionRsp.solution:type_name -> oj.solution.Solution
	31, // 10: oj.solution.QuerySimListRsp.sim:type_name -> oj.solution.Sim
	44, // 11: oj.solution.QuerySimSolutionDataRsp.solution:type_name -> oj.solution.Solution
	44, // 12: oj.solution.QuerySimSolutionDataRsp.simSolution:type_name -> oj.solution.Solution
	45, // 13: oj.solution.QueryLatestCodeRsp.lastCode:type_name -> oj.solution.Code
	44, // 14: oj.solution.QuerySourceCodeRsp.solution:type_name -> oj.solution.Solution
	19, // 15: oj.solution.CodeServer.AddCode:input_type -> oj.solution.AddCodeReq
	20, // 16: oj.solution.KeyActionServer.AddKeyAction:input_type -> oj.solution.AddKeyActionReq
	42, // 17: oj.solution.SolutionServer.CountUserProblemSolution:input_type -> oj.solution.CountUserProblemSolutionReq
	40, // 18: oj.solution.SolutionServer.RejudgeSolution:input_type -> oj.solution.RejudgeSolutionReq
	38, // 19: oj.solution.SolutionServer.QueryRuntimeInfo:input_type -> oj.solution.QueryRuntimeInfoReq
	36, // 20: oj.solution.SolutionServer.QuerySolutionResult:input_type -> oj.solution.QuerySolutionResultReq
	34, // 21: oj.solution.SolutionServer.QuerySourceCode:input_type -> oj.solution.QuerySourceCodeReq
	32, // 22: oj.solution.SolutionServer.QueryLatestCode:input_type -> oj.solution.QueryLatestCodeReq
	27, // 23: oj.solution.SolutionServer.QuerySimList:input_type -> oj.solution.QuerySimListReq
	29, // 24: oj.solution.SolutionServer.QuerySimSolutionData:input_type -> oj.solution.QuerySimSolutionDataReq
	26, // 25: oj.solution.SolutionServer.AddSolution:input_type -> oj.solution.AddSolutionReq
	24, // 26: oj.solution.SolutionServer.QueryUserProblemSolution:input_type -> oj.solution.QueryUserProblemSolutionReq
	22, // 27: oj.solution.SolutionServer.QuerySolution:input_type -> oj.solution.QuerySolutionReq
	26, // 28: oj.solution.SolutionServer.AddTestSolution:input_type -> oj.solution.AddSolutionReq
	14, // 29: oj.solution.SolutionServer.QueryContestRankData:input_type -> oj.solution.QueryContestRankDataReq
	0,  // 30: oj.solution.SolutionServer.QueryUserContestSubmission:input_type -> oj.solution.QueryUserContestSubmissionReq
	9,  // 31: oj.solution.SolutionServer.CountContestProblemSubmission:input_type -> oj.solution.CountContestProblemSubmissionReq
	5,  // 32: oj.solution.SolutionServer.QueryMySolutionRecord:input_type -> oj.solution.QueryMySolutionRecordReq
	5,  // 33: oj.solution.SolutionServer.CountMySolution:input_type -> oj.solution.QueryMySolutionRecordReq
	4,  // 34: oj.solution.SolutionServer.QueryTodaySolution:input_type -> oj.solution.UserIDReq
	41, // 35: oj.solution.CodeServer.AddCode:output_type -> oj.solution.CommonRsp
	41, // 36: oj.solution.KeyActionServer.AddKeyAction:output_type -> oj.solution.CommonRsp
	43, // 37: oj.solution.SolutionServer.CountUserProblemSolution:output_type -> oj.solution.CountUserProblemSolutionRsp
	41, // 38: oj.solution.SolutionServer.RejudgeSolution:output_type -> oj.solution.CommonRsp
	39, // 39: oj.solution.SolutionServer.QueryRuntimeInfo:output_type -> oj.solution.QueryRuntimeInfoRsp
	37, // 40: oj.solution.SolutionServer.QuerySolutionResult:output_type -> oj.solution.QuerySolutionResultRsp
	35, // 41: oj.solution.SolutionServer.QuerySourceCode:output_type -> oj.solution.QuerySourceCodeRsp
	33, // 42: oj.solution.SolutionServer.QueryLatestCode:output_type -> oj.solution.QueryLatestCodeRsp
	28, // 43: oj.solution.SolutionServer.QuerySimList:output_type -> oj.solution.QuerySimListRsp
	30, // 44: oj.solution.SolutionServer.QuerySimSolutionData:output_type -> oj.solution.QuerySimSolutionDataRsp
	21, // 45: oj.solution.SolutionServer.AddSolution:output_type -> oj.solution.AddSolutionRsp
	25, // 46: oj.solution.SolutionServer.QueryUserProblemSolution:output_type -> oj.solution.QueryUserProblemSolutionRsp
	23, // 47: oj.solution.SolutionServer.QuerySolution:output_type -> oj.solution.QuerySolutionRsp
	21, // 48: oj.solution.SolutionServer.AddTestSolution:output_type -> oj.solution.AddSolutionRsp
	15, // 49: oj.solution.SolutionServer.QueryContestRankData:output_type -> oj.solution.QueryContestRankDataRsp
	1,  // 50: oj.solution.SolutionServer.QueryUserContestSubmission:output_type -> oj.solution.QueryUserContestSubmissionRsp
	10, // 51: oj.solution.SolutionServer.CountContestProblemSubmission:output_type -> oj.solution.CountContestProblemSubmissionRsp
	6,  // 52: oj.solution.SolutionServer.QueryMySolutionRecord:output_type -> oj.solution.QueryMySolutionRecordRsp
	12, // 53: oj.solution.SolutionServer.CountMySolution:output_type -> oj.solution.CountContestSubmissionRsp
	3,  // 54: oj.solution.SolutionServer.QueryTodaySolution:output_type -> oj.solution.QueryTodaySolutionRsp
