...
var file_solution_proto_rawDesc = []byte{
	...
	0x12, 0x0b, 0x6f, 0x6a, 0x2e, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4a, 0x0a,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x31, 0x0a, 0x08,
	...
	0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x53,
	...
	0x65, 0x32, 0xbb, 0x04, 0x0a, 0x0e, 0x53, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65,
	...
	0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x73, 0x70, 0x22, 0x00, 0x42,
...
var file_solution_proto_goTypes = []any{
	(*QueryLatestCodeReq)(nil),          // 0: oj.solution.QueryLatestCodeReq
	(*QueryLatestCodeRsp)(nil),          // 1: oj.solution.QueryLatestCodeRsp
	(*QuerySourceCodeReq)(nil),          // 2: oj.solution.QuerySourceCodeReq
	(*QuerySourceCodeRsp)(nil),          // 3: oj.solution.QuerySourceCodeRsp
	(*QuerySolutionResultReq)(nil),      // 4: oj.solution.QuerySolutionResultReq
	(*QuerySolutionResultRsp)(nil),      // 5: oj.solution.QuerySolutionResultRsp
	(*QueryRuntimeInfoReq)(nil),         // 6: oj.solution.QueryRuntimeInfoReq
	(*QueryRuntimeInfoRsp)(nil),         // 7: oj.solution.QueryRuntimeInfoRsp
	(*RejudgeSolutionReq)(nil),          // 8: oj.solution.RejudgeSolutionReq
	(*CommonRsp)(nil),                   // 9: oj.solution.CommonRsp
	(*CountUserProblemSolutionReq)(nil), // 10: oj.solution.CountUserProblemSolutionReq
	(*CountUserProblemSolutionRsp)(nil), // 11: oj.solution.CountUserProblemSolutionRsp
	(*Solution)(nil),                    // 12: oj.solution.Solution
	(*Code)(nil),                        // 13: oj.solution.Code
}
var file_solution_proto_depIdxs = []int32{
	13, // 0: oj.solution.QueryLatestCodeRsp.lastCode:type_name -> oj.solution.Code
	12, // 1: oj.solution.QuerySourceCodeRsp.solution:type_name -> oj.solution.Solution
	10, // 2: oj.solution.SolutionServer.CountUserProblemSolution:input_type -> oj.solution.CountUserProblemSolutionReq
	8,  // 3: oj.solution.SolutionServer.RejudgeSolution:input_type -> oj.solution.RejudgeSolutionReq
	6,  // 4: oj.solution.SolutionServer.QueryRuntimeInfo:input_type -> oj.solution.QueryRuntimeInfoReq
	4,  // 5: oj.solution.SolutionServer.QuerySolutionResult:input_type -> oj.solution.QuerySolutionResultReq
	2,  // 6: oj.solution.SolutionServer.QuerySourceCode:input_type -> oj.solution.QuerySourceCodeReq
	0,  // 7: oj.solution.SolutionServer.QueryLatestCode:input_type -> oj.solution.QueryLatestCodeReq
	11, // 8: oj.solution.SolutionServer.CountUserProblemSolution:output_type -> oj.solution.CountUserProblemSolutionRsp
	9,  // 9: oj.solution.SolutionServer.RejudgeSolution:output_type -> oj.solution.CommonRsp
	7,  // 10: oj.solution.SolutionServer.QueryRuntimeInfo:output_type -> oj.solution.QueryRuntimeInfoRsp
	5,  // 11: oj.solution.SolutionServer.QuerySolutionResult:output_type -> oj.solution.QuerySolutionResultRsp
	3,  // 12: oj.solution.SolutionServer.QuerySourceCode:output_type -> oj.solution.QuerySourceCodeRsp
	1,  // 13: oj.solution.SolutionServer.QueryLatestCode:output_type -> oj.solution.QueryLatestCodeRsp
