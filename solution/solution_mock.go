...
// CountClassSolution mocks base method.
func (m *MockSolutionServerService) CountClassSolution(ctx context.Context, req *CountClassSolutionReq) (*CountClassSolutionRsp, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountClassSolution", ctx, req)
	ret0, _ := ret[0].(*CountClassSolutionRsp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountClassSolution indicates an expected call of CountClassSolution.
func (mr *MockSolutionServerServiceMockRecorder) CountClassSolution(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountClassSolution", reflect.TypeOf((*MockSolutionServerService)(nil).CountClassSolution), ctx, req)
}
...
// CountProblemSolutionStatistics mocks base method.
func (m *MockSolutionServerService) CountProblemSolutionStatistics(ctx context.Context, req *QueryAllUserSolutionReq) (*CountProblemSolutionStatisticsRsp, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountProblemSolutionStatistics", ctx, req)
	ret0, _ := ret[0].(*CountProblemSolutionStatisticsRsp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountProblemSolutionStatistics indicates an expected call of CountProblemSolutionStatistics.
func (mr *MockSolutionServerServiceMockRecorder) CountProblemSolutionStatistics(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockSolutionServerService) QueryMyLanguageDistribution(ctx context.Context, req *UserIDReq) (*QueryMyLanguageDistributionRsp, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryMyLanguageDistribution", ctx, req)
	ret0, _ := ret[0].(*QueryMyLanguageDistributionRsp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// QueryMyLanguageDistribution indicates an expected call of QueryMyLanguageDistribution.
func (mr *MockSolutionServerServiceMockRecorder) QueryMyLanguageDistribution(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryMyLanguageDistribution", reflect.TypeOf((*MockSolutionServerService)(nil).QueryMyLanguageDistribution), ctx, req)
}

// QueryMySolution mocks base method.
func (m *MockSolutionServerService) QueryMySolution(ctx context.Context, req *UserIDReq) (*QuerySolutionRsp, error) {
	m.ctrl.T.Helper()
...
// CountClassSolution mocks base method.
func (m *MockSolutionServerClientProxy) CountClassSolution(ctx context.Context, req *CountClassSolutionReq, opts ...client.Option) (*CountClassSolutionRsp, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, req}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "CountClassSolution", varargs...)
	ret0, _ := ret[0].(*CountClassSolutionRsp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// CountClassSolution indicates an expected call of CountClassSolution.
func (mr *MockSolutionServerClientProxyMockRecorder) CountClassSolution(ctx, req any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, req}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountClassSolution", reflect.TypeOf((*MockSolutionServerClientProxy)(nil).CountClassSolution), varargs...)
}
...
// CountProblemSolutionStatistics mocks base method.
func (m *MockSolutionServerClientProxy) CountProblemSolutionStatistics(ctx context.Context, req *QueryAllUserSolutionReq, opts ...client.Option) (*CountProblemSolutionStatisticsRsp, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, req}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "CountProblemSolutionStatistics", varargs...)
	ret0, _ := ret[0].(*CountProblemSolutionStatisticsRsp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// CountProblemSolutionStatistics indicates an expected call of CountProblemSolutionStatistics.
func (mr *MockSolutionServerClientProxyMockRecorder) CountProblemSolutionStatistics(ctx, req any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, req}, opts...)
...
func (m *MockSolutionServerClientProxy) QueryMyLanguageDistribution(ctx context.Context, req *UserIDReq, opts ...client.Option) (*QueryMyLanguageDistributionRsp, error) {
	...
	ret := m.ctrl.Call(m, "QueryMyLanguageDistribution", varargs...)
	ret0, _ := ret[0].(*QueryMyLanguageDistributionRsp)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// QueryMyLanguageDistribution indicates an expected call of QueryMyLanguageDistribution.
func (mr *MockSolutionServerClientProxyMockRecorder) QueryMyLanguageDistribution(ctx, req any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, req}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryMyLanguageDistribution", reflect.TypeOf((*MockSolutionServerClientProxy)(nil).QueryMyLanguageDistribution), varargs...)
}

// QueryMySolution mocks base method.
func (m *MockSolutionServerClientProxy) QueryMySolution(ctx context.Context, req *UserIDReq, opts ...client.Option) (*QuerySolutionRsp, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, req}
	for _, a := range opts {
		varargs = append(varargs, a)
